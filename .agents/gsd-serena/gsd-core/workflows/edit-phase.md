...
Examples:
  `gsd-serena-bridge edit-phase --format markdown 5`       → phase = 5, force = false
  `gsd-serena-bridge edit-phase --format markdown 5 --force` → phase = 5, force = true
  `gsd-serena-bridge edit-phase --format markdown 12.1`    → phase = 12.1, force = false

If no argument provided:

```
ERROR: Phase number required
Usage: gsd-serena-bridge edit-phase --format markdown <phase-number> [--force]
Example: gsd-serena-bridge edit-phase --format markdown 5
Example: gsd-serena-bridge edit-phase --format markdown 5 --force
```
...
To edit anyway, run:
  gsd-serena-bridge edit-phase --format markdown {target} --force
```
