...
`gsd-serena-bridge discuss-phase --format markdown {phase}` — gather context and clarify approach

---

**Also available:**
- `gsd-serena-bridge ui-phase --format markdown {phase}` — generate UI design contract (recommended for frontend phases)
- `gsd-serena-bridge plan-phase --format markdown {phase}` — skip discussion, plan directly
- `gsd-serena-bridge discuss-phase --format markdown {phase}` — include assumptions check before planning
...
`gsd-serena-bridge discuss-phase --format markdown {phase} ${GSD_WS}` — gather context and clarify approach

---

**Also available:**
- `gsd-serena-bridge plan-phase --format markdown {phase} ${GSD_WS}` — skip discussion, plan directly
- `gsd-serena-bridge discuss-phase --format markdown {phase} ${GSD_WS}` — include assumptions check before planning
...
`gsd-serena-bridge plan-phase --format markdown {phase} --gaps ${GSD_WS}`

---

**Also available:**
- `gsd-serena-bridge execute-phase --format markdown {phase} ${GSD_WS}` — execute phase plans
- `gsd-serena-bridge verify-work --format markdown {phase} ${GSD_WS}` — run more UAT testing
...
`gsd-serena-bridge verify-work --format markdown {phase} ${GSD_WS}` — resume testing from where you left off

---

**Also available:**
- `gsd-serena-bridge audit-uat --format markdown ${GSD_WS}` — full cross-phase UAT audit
- `gsd-serena-bridge execute-phase --format markdown {phase} ${GSD_WS}` — execute phase plans
...
`gsd-serena-bridge verify-work --format markdown {phase} ${GSD_WS}` — resume human verification
...
`gsd-serena-bridge discuss-phase --format markdown {Z+1}` — gather context and clarify approach

---

**Also available:**
- `gsd-serena-bridge ui-phase --format markdown {Z+1}` — generate UI design contract (recommended for frontend phases)
- `gsd-serena-bridge plan-phase --format markdown {Z+1}` — skip discussion, plan directly
- `gsd-serena-bridge verify-work --format markdown {Z}` — user acceptance test before continuing
...
`gsd-serena-bridge discuss-phase --format markdown {Z+1} ${GSD_WS}` — gather context and clarify approach

---

**Also available:**
- `gsd-serena-bridge plan-phase --format markdown {Z+1} ${GSD_WS}` — skip discussion, plan directly
- `gsd-serena-bridge verify-work --format markdown {Z} ${GSD_WS}` — user acceptance test before continuing
...
`gsd-serena-bridge complete-milestone --format markdown ${GSD_WS}`

---

**Also available:**
- `gsd-serena-bridge verify-work --format markdown ${GSD_WS}` — user acceptance test before completing milestone
...
`gsd-serena-bridge new-milestone --format markdown ${GSD_WS}`
...
- Phase complete but next phase not planned → offer `gsd-serena-bridge plan-phase --format markdown [next] ${GSD_WS}`
- All work complete → offer milestone completion
- Blockers present → highlight before offering to continue
- Handoff file exists → mention it, offer `gsd-serena-bridge resume-work --format markdown ${GSD_WS}`
</step>
...
- Check 2 (orphaned handoff): `Read the handoff file(s) and resume from where work was paused: gsd-serena-bridge resume-work --format markdown ${GSD_WS}`
...
- Check 1 (STATE inconsistency): `Run gsd-serena-bridge verify-work --format markdown ${PHASE} ${GSD_WS} to reconcile state`
</step>
...
- [ ] Smart routing: gsd-serena-bridge execute-phase --format markdown if plans exist, gsd-serena-bridge plan-phase --format markdown if not
