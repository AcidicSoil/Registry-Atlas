...
- gsd-serena-bridge complete-milestone --format markdown (if last phase in milestone)
- gsd-serena-bridge progress --format markdown (to see what's next)
...
- gsd-serena-bridge complete-milestone --format markdown — if all phases in milestone are done
- gsd-serena-bridge progress --format markdown — see overall project state
- gsd-serena-bridge execute-phase --format markdown {next} — continue to next phase
</offer_next>
