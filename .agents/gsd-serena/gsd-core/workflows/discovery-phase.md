...
See .agents/gsd-serena/gsd-core/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using .agents/gsd-serena/gsd-core/templates/discovery.md structure:
...
1. **Scope the discovery** using .agents/gsd-serena/gsd-core/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from .agents/gsd-serena/gsd-core/templates/discovery.md
...
Use .agents/gsd-serena/gsd-core/templates/discovery.md.
