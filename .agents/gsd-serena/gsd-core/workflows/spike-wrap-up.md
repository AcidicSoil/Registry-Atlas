...
`./.agents/gsd-serena/skills/spike-findings-[project]/` (project-local) and summary to
`.planning/spikes/WRAP-UP-SUMMARY.md`. Companion to `gsd-serena-bridge spike --format markdown`.
</purpose>
...
3. Check if `./.agents/gsd-serena/skills/spike-findings-*/SKILL.md` exists for this project
...
Run `gsd-serena-bridge spike --format markdown` first to create experiments.
```
Exit.
...
2. The skill will be created at `./.agents/gsd-serena/skills/spike-findings-[project-dir-name]/`
...
**Feature areas:** [list]
**Skill output:** `./.agents/gsd-serena/skills/spike-findings-[project]/`
...
**Processed:** {N} spikes
**Feature areas:** {list}
**Skill:** `./.agents/gsd-serena/skills/spike-findings-[project]/`
...
`gsd-serena-bridge spike --format markdown` (run with no argument — its frontier mode analyzes the spike landscape and proposes integration and frontier spikes)

───────────────────────────────────────────────────────────────

**Also available:**
- `gsd-serena-bridge plan-phase --format markdown` — start planning the real implementation
- `gsd-serena-bridge spike --format markdown [idea]` — spike a specific new idea
...
- [ ] Spike-findings skill exists at `./.agents/gsd-serena/skills/` with SKILL.md (including requirements), references/, sources/
...
- [ ] Summary presented
- [ ] Next-step options presented (including frontier spike exploration via `gsd-serena-bridge spike --format markdown`)
</success_criteria>
