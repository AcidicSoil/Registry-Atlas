...
Seeds auto-surface during gsd-serena-bridge new-milestone --format markdown when trigger conditions match the
...
_To be filled in. Run `gsd-serena-bridge capture --format markdown --seed --enrich SEED-{PADDED}` to add context._

## When to Surface

**Trigger:** when relevant

This seed will surface during `gsd-serena-bridge new-milestone --format markdown` when the milestone scope matches.

## Scope Estimate

**Unknown** — run `gsd-serena-bridge capture --format markdown --seed --enrich SEED-{PADDED}` to estimate effort.
...
Trigger and scope are set to defaults. Run `gsd-serena-bridge capture --format markdown --seed --enrich SEED-{PADDED}`
to add trigger conditions, rationale, and scope estimate at your convenience.

This seed will surface automatically when you run gsd-serena-bridge new-milestone --format markdown.
```
</step>
