...
| `serena`    | `gpt-5.5`                     | `gpt-5.4`                       | `gpt-5.4-mini`                |
...
AskUserQuestion([
  {
    ...
    options: [
      ...
      { label: "Common runtimes", description: "claude, serena, gemini, qwen" },
...
AskUserQuestion([
  {
    ...
    options: [
      ...
      { label: "serena", description: "OpenAI runtime CLI." },
...
AskUserQuestion([
  {
    ...
    options: [
      ...
      { label: "openai", description: "gpt-5.5 / gpt-5.4 / gpt-5.4-mini (OpenAI)" },
...
These settings apply to future gsd-serena-bridge plan-phase --format markdown, gsd-serena-bridge execute-phase --format markdown, gsd-serena-bridge discuss-phase --format markdown,
and gsd-serena-bridge ship --format markdown runs.

For common-case toggles (model profile, research/plan_check/verifier, branching strategy,
UI/AI phase gates), use gsd-serena-bridge settings --format markdown.
```
</step>
