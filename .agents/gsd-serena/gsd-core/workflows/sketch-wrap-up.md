...
UI implementation. Reads from `.planning/sketches/`, writes skill to `./.agents/gsd-serena/skills/sketch-findings-[project]/`
...
3. Check if `./.agents/gsd-serena/skills/sketch-findings-*/SKILL.md` exists for this project
...
Derive from the project directory name: `./.agents/gsd-serena/skills/sketch-findings-[project-dir-name]/`
...
**Design areas:** [list]
**Skill output:** `./.agents/gsd-serena/skills/sketch-findings-[project]/`
...
**Design areas:** {list}
**Skill:** `./.agents/gsd-serena/skills/sketch-findings-[project]/`
...
- [ ] Sketch-findings skill exists at `./.agents/gsd-serena/skills/` with SKILL.md, references/, sources/
