...
- gsd-serena-bridge review --format markdown — Run cross-AI peer review on a specific phase plan
- gsd-serena-bridge ship --format markdown — Create a PR from completed work
- gsd-serena-bridge progress --format markdown — See overall project state
- gsd-serena-bridge inbox --format markdown --label — Re-run with auto-labeling enabled
</offer_next>
