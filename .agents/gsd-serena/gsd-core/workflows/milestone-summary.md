...
4. If nothing found: error "No milestone found. Run gsd-serena-bridge new-project --format markdown or gsd-serena-bridge new-milestone --format markdown first."
...
If the user is done:
- Suggest next steps: `gsd-serena-bridge new-milestone --format markdown`, `gsd-serena-bridge progress --format markdown`, or sharing the summary with the team
