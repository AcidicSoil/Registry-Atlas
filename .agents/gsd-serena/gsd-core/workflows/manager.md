...
**If `RUNTIME` is not `claude` (e.g. Serena bridge):** Spawn a background agent that delegates to the Skill pipeline with any configured flags:
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 ...
 Resume anytime: gsd-serena-bridge manager --format markdown
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
```

**Note:** Any background agents still running will continue to completion. Their results will be visible on next `gsd-serena-bridge manager --format markdown` or `gsd-serena-bridge progress --format markdown` invocation.
