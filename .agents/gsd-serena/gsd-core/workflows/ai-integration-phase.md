...
<required_reading>
@.agents/gsd-serena/gsd-core/references/ai-frameworks.md
@.agents/gsd-serena/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read .agents/gsd-serena/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp ".agents/gsd-serena/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read .agents/gsd-serena/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read .agents/gsd-serena/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read .agents/gsd-serena/agents/gsd-eval-planner.md for instructions.
