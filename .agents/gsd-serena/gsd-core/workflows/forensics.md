...
3. {Recovery command if applicable — e.g., `gsd-serena-bridge resume-work --format markdown`, `gsd-serena-bridge execute-phase --format markdown N`}

---

*Report generated by `gsd-serena-bridge forensics --format markdown`. All paths redacted for portability.*
```
