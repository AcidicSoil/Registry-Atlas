...
```markdown
Read .agents/gsd-serena/agents/gsd-ui-researcher.md for instructions.
...
Template: .agents/gsd-serena/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read .agents/gsd-serena/agents/gsd-ui-checker.md for instructions.
