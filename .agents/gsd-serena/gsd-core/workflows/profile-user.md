...
Key references:
- @.agents/gsd-serena/gsd-core/references/ui-brand.md (display patterns)
- @.agents/gsd-serena/agents/gsd-user-profiler.md (profiler agent definition)
- @.agents/gsd-serena/gsd-core/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH=".agents/gsd-serena/gsd-core/USER-PROFILE.md"
...
```bash
cp ".agents/gsd-serena/gsd-core/USER-PROFILE.md" ".agents/gsd-serena/USER-PROFILE.backup.md"
```
...
✓ Stores profile at .agents/gsd-serena/gsd-core/USER-PROFILE.md
...
- The user-profiling reference doc at `.agents/gsd-serena/gsd-core/references/user-profiling.md`
...
Reference: @.agents/gsd-serena/gsd-core/references/user-profiling.md
...
Display: "✓ Profile written to .agents/gsd-serena/gsd-core/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  - "gsd-serena-bridge dev-preferences --format markdown command file" -- "Load your preferences in any session"
  - "AGENTS.md profile section" -- "Add profile to this project's AGENTS.md"
  - "Global AGENTS.md" -- "Add profile to .agents/gsd-serena/AGENTS.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at .agents/gsd-serena/gsd-core/USER-PROFILE.md" and jump to step 10.
...
**For gsd-serena-bridge dev-preferences --format markdown (if selected):**

```bash
gsd_run query generate-dev-preferences --analysis "$ANALYSIS_PATH" --json
```

Display: "✓ Generated gsd-serena-bridge dev-preferences --format markdown at .agents/gsd-serena/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to .agents/gsd-serena/AGENTS.md"
...
```bash
BACKUP_PATH=".agents/gsd-serena/USER-PROFILE.backup.md"
```
...
Your profile:    .agents/gsd-serena/gsd-core/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ gsd-serena-bridge dev-preferences --format markdown   .agents/gsd-serena/skills/gsd-dev-preferences/SKILL.md
  ✓ AGENTS.md section       <resolved claude_md_path, default ./.agents/gsd-serena/AGENTS.md>
  ✓ Global AGENTS.md        .agents/gsd-serena/AGENTS.md
```

(Show the `claude_md_path` actually returned by the command — it defaults to `./.agents/gsd-serena/AGENTS.md` but may be overridden by config or `--output`.)
