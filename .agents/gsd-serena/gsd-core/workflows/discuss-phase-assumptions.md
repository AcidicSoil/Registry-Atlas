...
`gsd-serena-bridge plan-phase --format markdown ${PHASE}`

---

**Also available:**
- `gsd-serena-bridge plan-phase --format markdown ${PHASE} --skip-research` — plan without research
- `gsd-serena-bridge ui-phase --format markdown ${PHASE}` — generate UI design contract (if frontend work)
