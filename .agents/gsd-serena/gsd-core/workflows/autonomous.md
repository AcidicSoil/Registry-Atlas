...
Read and execute: `.agents/gsd-serena/gsd-core/references/autonomous-smart-discuss.md`
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 ...
 Resume with: gsd-serena-bridge autonomous --format markdown --from ${next_incomplete_phase}
```
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 ...
 Lifecycle skipped — run gsd-serena-bridge autonomous --format markdown without --only
...
On **"Stop"**: Go to handle_blocker with "User stopped — audit gaps remain. Run gsd-serena-bridge audit-milestone --format markdown to review, then gsd-serena-bridge complete-milestone --format markdown when ready."
...
On **"Stop"**: Go to handle_blocker with "User stopped — tech debt to address. Run gsd-serena-bridge audit-milestone --format markdown to review details."
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 ...
 Resume with: gsd-serena-bridge autonomous --format markdown ${ONLY_PHASE ? "--only " + ONLY_PHASE : "--from " + next_phase}${TO_PHASE ? " --to " + TO_PHASE : ""}
```
