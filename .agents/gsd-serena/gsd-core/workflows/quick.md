...
- ./AGENTS.md or ./.agents/gsd-serena/AGENTS.md (if exists — project-specific guidelines)
...
- ./AGENTS.md or ./.agents/gsd-serena/AGENTS.md (if exists — follow project-specific guidelines)
...
- .planning/STATE.md (Project state)
- ./AGENTS.md or ./.agents/gsd-serena/AGENTS.md (Project instructions, if exists)
- .agents/gsd-serena/skills/ or .agents/skills/ (Project skills, if either exists — list skills, read SKILL.md for each, follow relevant rules during implementation)
</files_to_read>
...
Ready for next task: gsd-serena-bridge quick --format markdown ${GSD_WS}
```
