...
- This section feeds directly into gsd-serena-bridge plan-phase --format markdown --gaps
...
5. status → "diagnosed"
6. Ready for gsd-serena-bridge plan-phase --format markdown --gaps with root causes
...
**Creation:** When gsd-serena-bridge verify-work --format markdown starts new session
...
- `gsd-serena-bridge verify-work --format markdown {phase}` picks up from first pending/blocked test
