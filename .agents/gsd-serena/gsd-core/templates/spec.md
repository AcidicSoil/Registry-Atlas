...
*Phase: [XX-name]*
*Spec created: [date]*
*Next step: gsd-serena-bridge discuss-phase --format markdown [X] — implementation decisions (how to build what's specified above)*
```
...
*Next step: gsd-serena-bridge discuss-phase --format markdown 3 — implementation decisions (card layout, loading skeleton, etc.)*
```
...
*Spec created: 2025-01-20*
*Next step: gsd-serena-bridge discuss-phase --format markdown 2 — implementation decisions (progress reporting, flag design, etc.)*
```
