...
**CRITICAL:** If CONTEXT.md exists from gsd-serena-bridge discuss-phase --format markdown, copy locked decisions here verbatim. These MUST be honored by the planner.
