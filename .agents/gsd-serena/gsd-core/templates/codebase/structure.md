...
- Usage: Reference from command with `@.agents/gsd-serena/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to .agents/gsd-serena/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to .agents/gsd-serena/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
