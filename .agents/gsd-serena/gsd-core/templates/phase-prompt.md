...
<!-- For checkpoint task examples and patterns, see @.agents/gsd-serena/gsd-core/references/checkpoints.md -->
...
**Wave is pre-computed:** Wave numbers are assigned during `gsd-serena-bridge plan-phase --format markdown`. Execute-phase reads `wave` directly from frontmatter and groups plans by wave number. No runtime dependency analysis needed.
...
See `.agents/gsd-serena/gsd-core/references/tdd.md` for TDD plan structure.
...
See `.agents/gsd-serena/gsd-core/templates/user-setup.md` for full schema and examples
...
See `.agents/gsd-serena/gsd-core/workflows/verify-phase.md` for verification logic.
