...
For deep ecosystem research ("how do experts build this"), use `gsd-serena-bridge plan-phase --format markdown --research-phase` which produces RESEARCH.md.
...
- Use `gsd-serena-bridge plan-phase --format markdown --research-phase` for these
</guidelines>
