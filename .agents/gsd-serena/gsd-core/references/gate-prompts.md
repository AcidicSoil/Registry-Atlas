...
- header: "Escalate"
- options: Accept gaps | Re-plan (via gsd-serena-bridge plan-phase --format markdown) | Debug (via gsd-serena-bridge debug --format markdown) | Retry
...
- header: "Scope"
- options: Quick task | Full plan (via gsd-serena-bridge plan-phase --format markdown) | Revise
