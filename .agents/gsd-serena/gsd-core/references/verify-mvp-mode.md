...
- The phase under verification has `**Mode:** mvp` in ROADMAP.md (parsed via `node "$HOME/.agents/gsd-serena/gsd-core/bin/gsd-tools.cjs" query roadmap.get-phase --pick mode`).
