...
the agent/Serena bridge instances are active on the same repo at the same time. One session can
...
node "$HOME/.agents/gsd-serena/gsd-core/bin/gsd-tools.cjs" query state.json --ws feature-a
node "$HOME/.agents/gsd-serena/gsd-core/bin/gsd-tools.cjs" query find-phase 3 --ws feature-b
...
# Workstream CRUD
node "$HOME/.agents/gsd-serena/gsd-core/bin/gsd-tools.cjs" query workstream.create <name>
node "$HOME/.agents/gsd-serena/gsd-core/bin/gsd-tools.cjs" query workstream.list
node "$HOME/.agents/gsd-serena/gsd-core/bin/gsd-tools.cjs" query workstream.status <name>
node "$HOME/.agents/gsd-serena/gsd-core/bin/gsd-tools.cjs" query workstream.complete <name>
```
