...
function buildClaudeMdFallbacks(runtime) {
    return {
        ...
        skills: 'No project skills found. Add skills to any of: `.claude/skills/`, `.agents/skills/`, `.cursor/skills/`, `.github/skills/`, or `.agents/gsd-serena/skills/` with a `SKILL.md` index file.',
    };
}
// Directories where project skills may live (checked in order)
const SKILL_SEARCH_DIRS = ['.claude/skills', '.agents/skills', '.cursor/skills', '.github/skills', '.agents/gsd-serena/skills'];
