...
- Do not invoke vendor-native skill names from this surface. Use the bridge command when it exists: `gsd-serena-bridge ship --format markdown`.
...
<execution_context>
@.agents/gsd-serena/gsd-core/workflows/ship.md
</execution_context>

Execute the ship workflow from @.agents/gsd-serena/gsd-core/workflows/ship.md end-to-end.
