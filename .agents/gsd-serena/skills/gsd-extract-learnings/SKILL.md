...
- Do not invoke vendor-native skill names from this surface. Use the bridge command when it exists: `gsd-serena-bridge extract-learnings --format markdown`.
...
<execution_context>
@.agents/gsd-serena/gsd-core/workflows/extract-learnings.md
</execution_context>

Execute the extract-learnings workflow from @.agents/gsd-serena/gsd-core/workflows/extract-learnings.md end-to-end.
