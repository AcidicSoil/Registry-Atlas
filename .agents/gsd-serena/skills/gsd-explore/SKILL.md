...
- Do not invoke vendor-native skill names from this surface. Use the bridge command when it exists: `gsd-serena-bridge explore --format markdown`.
...
Accepts an optional topic argument: `gsd-serena-bridge explore --format markdown authentication strategy`
</objective>

<execution_context>
@.agents/gsd-serena/gsd-core/workflows/explore.md
</execution_context>
