...
- Do not invoke vendor-native skill names from this surface. Use the bridge command when it exists: `gsd-serena-bridge audit-uat --format markdown`.
...
<execution_context>
@.agents/gsd-serena/gsd-core/workflows/audit-uat.md
</execution_context>
