...
description: "Researches how to implement a phase before planning. Produces RESEARCH.md consumed by gsd-planner. Spawned by gsd-serena-bridge plan-phase --format markdown orchestrator."
---
...
purpose: Researches how to implement a phase before planning. Produces RESEARCH.md consumed by gsd-planner. Spawned by gsd-serena-bridge plan-phase --format markdown orchestrator.
</serena_agent_role>
...
<philosophy>
@.agents/gsd-serena/gsd-core/references/research-philosophy.md
</philosophy>
...
| `brave` | `node "$HOME/.agents/gsd-serena/gsd-core/bin/gsd-tools.cjs" query websearch "<fetch.query>"` (Brave-backed) or built-in `WebSearch` |
...
@.agents/gsd-serena/gsd-core/references/research-verification-protocol.md
...
- **Phase gate:** Full suite green before `gsd-serena-bridge verify-work --format markdown`
...
@.agents/gsd-serena/gsd-core/references/thinking-models-research.md
...
For each domain, use the `<tool_strategy>` seam (Steps A–D): build questions JSON, call `node "$HOME/.agents/gsd-serena/gsd-core/bin/gsd-tools.cjs" query research-plan`, run the indicated provider per item, then cache each digest. Document findings with confidence levels as you go (use `node "$HOME/.agents/gsd-serena/gsd-core/bin/gsd-tools.cjs" query classify-confidence --provider <id>` to obtain the tier).
