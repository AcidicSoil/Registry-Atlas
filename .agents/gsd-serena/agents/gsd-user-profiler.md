...
<reference>
@.agents/gsd-serena/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `.agents/gsd-serena/gsd-core/references/user-profiling.md` to load:
