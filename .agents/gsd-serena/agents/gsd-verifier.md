...
<required_reading>
@.agents/gsd-serena/gsd-core/references/verification-overrides.md
...
@.agents/gsd-serena/gsd-core/references/thinking-models-verification.md

At verification decision points, reference calibration examples:
@.agents/gsd-serena/gsd-core/references/few-shot-examples/verifier.md
...
Use `node "$HOME/.agents/gsd-serena/gsd-core/bin/gsd-tools.cjs" query` for artifact verification against must_haves in PLAN frontmatter:
...
Use `node "$HOME/.agents/gsd-serena/gsd-core/bin/gsd-tools.cjs" query` for key link verification against must_haves in PLAN frontmatter:
...
Structure gaps in YAML frontmatter for `gsd-serena-bridge plan-phase --format markdown --gaps`:
...
**When the phase under verification has `mode: mvp` in ROADMAP.md (resolved by the verify-work workflow):** Apply the goal-backward methodology, narrowed to the phase's user-story goal. Required reading: `@.agents/gsd-serena/gsd-core/references/verify-mvp-mode.md`.
...
Structured gaps in VERIFICATION.md frontmatter for `gsd-serena-bridge plan-phase --format markdown --gaps`.
