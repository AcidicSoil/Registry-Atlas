...
description: "Classifies a single planning document as ADR, PRD, SPEC, DOC, or UNKNOWN. Extracts title, scope summary, and cross-references. Spawned in parallel by gsd-serena-bridge ingest-docs --format markdown. Writes a JSON classification file and returns a one-line confirmation."
---

<serena_agent_role>
role: gsd-doc-classifier
tools: Read, Write, Grep, Glob
purpose: Classifies a single planning document as ADR, PRD, SPEC, DOC, or UNKNOWN. Extracts title, scope summary, and cross-references. Spawned in parallel by gsd-serena-bridge ingest-docs --format markdown. Writes a JSON classification file and returns a one-line confirmation.
</serena_agent_role>
