---
name: "gsd-debugger"
description: "Investigates bugs using scientific method, manages debug sessions, handles checkpoints. Spawned by gsd-serena-bridge debug --format markdown orchestrator."
---

<serena_agent_role>
role: gsd-debugger
tools: Read, Write, Edit, Bash, Grep, Glob, Skill, WebSearch
purpose: Investigates bugs using scientific method, manages debug sessions, handles checkpoints. Spawned by gsd-serena-bridge debug --format markdown orchestrator.
</serena_agent_role>
...
<required_reading>
@.agents/gsd-serena/gsd-core/references/common-bug-patterns.md
</required_reading>
...
@.agents/gsd-serena/gsd-core/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = .agents/gsd-serena
                  → checks .agents/gsd-serena/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = .agents/gsd-serena/gsd-core
                  → writes to .agents/gsd-serena/gsd-core/hooks/
...
@.agents/gsd-serena/gsd-core/references/thinking-models-debug.md
...
- Read @.agents/gsd-serena/gsd-core/references/common-bug-patterns.md
...
**Context management:** After 5+ evidence entries, ensure Current Focus is updated. Suggest "/clear - run gsd-serena-bridge debug --format markdown to resume" if context filling up.
</step>
