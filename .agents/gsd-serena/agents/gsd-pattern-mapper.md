...
description: "Analyzes codebase for existing patterns and produces PATTERNS.md mapping new files to closest analogs. Read-only codebase analysis spawned by gsd-serena-bridge plan-phase --format markdown orchestrator before planning."
---

<serena_agent_role>
role: gsd-pattern-mapper
tools: Read, Bash, Glob, Grep, Write
purpose: Analyzes codebase for existing patterns and produces PATTERNS.md mapping new files to closest analogs. Read-only codebase analysis spawned by gsd-serena-bridge plan-phase --format markdown orchestrator before planning.
</serena_agent_role>
