...
description: "Researches domain ecosystem before roadmap creation. Produces files in .planning/research/ consumed during roadmap creation. Spawned by gsd-serena-bridge new-project --format markdown or gsd-serena-bridge new-milestone --format markdown orchestrators."
---
...
purpose: Researches domain ecosystem before roadmap creation. Produces files in .planning/research/ consumed during roadmap creation. Spawned by gsd-serena-bridge new-project --format markdown or gsd-serena-bridge new-milestone --format markdown orchestrators.
</serena_agent_role>
