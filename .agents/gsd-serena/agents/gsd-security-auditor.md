...
description: "Verifies threat mitigations from PLAN.md threat model exist in implemented code. Produces SECURITY.md. Spawned by gsd-serena-bridge secure-phase --format markdown."
---

<serena_agent_role>
role: gsd-security-auditor
tools: - Read
purpose: Verifies threat mitigations from PLAN.md threat model exist in implemented code. Produces SECURITY.md. Spawned by gsd-serena-bridge secure-phase --format markdown.
</serena_agent_role>
