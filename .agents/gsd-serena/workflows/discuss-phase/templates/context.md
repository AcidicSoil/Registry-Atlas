# Bridge Workflow: discuss-phase-templates-context

<!-- generated-by: pnpm gen:bridge-commands -->

## Purpose

This bridge workflow runbook translates the actual GSD-core workflow information and adapts it for Serena bridge operation. Read it when operating `gsd-workflow-discuss-phase-templates-context` in a target project.
...
- Contract ID: `gsd-workflow-discuss-phase-templates-context`
- Status: `planned`
- Source path: `gsd-core/workflows/discuss-phase/templates/context.md`
- Resolved source path: `vendor/reference/gsd-core/gsd-core/workflows/discuss-phase/templates/context.md`
- Mirrored runbook path: `.agents/gsd-serena/workflows/discuss-phase/templates/context.md`
