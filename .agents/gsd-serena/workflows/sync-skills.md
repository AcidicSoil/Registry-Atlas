# Bridge Workflow: sync-skills

<!-- generated-by: pnpm gen:bridge-commands -->

## Purpose

This bridge workflow runbook translates the actual GSD-core workflow information and adapts it for Serena bridge operation. Read it when operating `gsd-workflow-sync-skills` in a target project.
...
- Contract ID: `gsd-workflow-sync-skills`
- Status: `planned`
- Source path: `gsd-core/workflows/sync-skills.md`
- Resolved source path: `vendor/reference/gsd-core/gsd-core/workflows/sync-skills.md`
- Mirrored runbook path: `.agents/gsd-serena/workflows/sync-skills.md`
...
4. **No cross-runtime content transformation.** Sync copies files verbatim. It does not apply runtime-specific content transformations (those happen at install time). If a runtime requires transformed content (e.g. Augment's format differs), the developer s...
