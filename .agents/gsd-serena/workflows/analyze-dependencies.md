# Bridge Workflow: analyze-dependencies

<!-- generated-by: pnpm gen:bridge-commands -->

## Purpose

This bridge workflow runbook translates the actual GSD-core workflow information and adapts it for Serena bridge operation. Read it when operating `gsd-workflow-analyze-dependencies` in a target project.
...
- Contract ID: `gsd-workflow-analyze-dependencies`
- Status: `planned`
- Source path: `gsd-core/workflows/analyze-dependencies.md`
- Resolved source path: `vendor/reference/gsd-core/gsd-core/workflows/analyze-dependencies.md`
- Mirrored runbook path: `.agents/gsd-serena/workflows/analyze-dependencies.md`

## Translated GSD Workflow

<purpose>
Analyze ROADMAP.md phases for dependency relationships before execution. Detect file overlap between phases, semantic API/data-flow dependencies, and suggest `Depends on` entries to prevent merge conflicts during parallel execution by ``gsd-serena-bridge manager --format markdown``.
</purpose>
...
Read `.planning/ROADMAP.md`. If it does not exist, error: "No ROADMAP.md found — run ``gsd-serena-bridge new-project --format markdown`` first."
...
After applying: "ROADMAP.md updated. Run ``gsd-serena-bridge manager --format markdown`` to execute phases in the correct order."
