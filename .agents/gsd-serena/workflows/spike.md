# Bridge Workflow: spike

<!-- generated-by: pnpm gen:bridge-commands -->

## Purpose

This bridge workflow runbook translates the actual GSD-core workflow information and adapts it for Serena bridge operation. Read it when operating `gsd-workflow-spike` in a target project.
...
- Contract ID: `gsd-workflow-spike`
- Status: `planned`
- Source path: `gsd-core/workflows/spike.md`
- Resolved source path: `vendor/reference/gsd-core/gsd-core/workflows/spike.md`
- Mirrored runbook path: `.agents/gsd-serena/workflows/spike.md`
...
Before starting each spike (not just the first), re-read `.planning/spikes/MANIFEST.md` and `.planning/spikes/CONVENTIONS.md` to prevent drift within long sessions. Check the Requirements section — make sure the spike doesn't contradict any established requ...
</step>
