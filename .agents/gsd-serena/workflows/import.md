# Bridge Workflow: import

<!-- generated-by: pnpm gen:bridge-commands -->

## Purpose

This bridge workflow runbook translates the actual GSD-core workflow information and adapts it for Serena bridge operation. Read it when operating `gsd-workflow-import` in a target project.
...
- Contract ID: `gsd-workflow-import`
- Status: `planned`
- Source path: `gsd-core/workflows/import.md`
- Resolved source path: `vendor/reference/gsd-core/gsd-core/workflows/import.md`
- Mirrored runbook path: `.agents/gsd-serena/workflows/import.md`
