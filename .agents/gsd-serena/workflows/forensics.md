# Bridge Workflow: forensics

<!-- generated-by: pnpm gen:bridge-commands -->

## Purpose

This bridge workflow runbook translates the actual GSD-core workflow information and adapts it for Serena bridge operation. Read it when operating `gsd-workflow-forensics` in a target project.
...
- Contract ID: `gsd-workflow-forensics`
- Status: `planned`
- Source path: `gsd-core/workflows/forensics.md`
- Resolved source path: `vendor/reference/gsd-core/gsd-core/workflows/forensics.md`
- Mirrored runbook path: `.agents/gsd-serena/workflows/forensics.md`
