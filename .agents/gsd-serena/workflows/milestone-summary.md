# Bridge Workflow: milestone-summary

<!-- generated-by: pnpm gen:bridge-commands -->

## Purpose

This bridge workflow runbook translates the actual GSD-core workflow information and adapts it for Serena bridge operation. Read it when operating `gsd-workflow-milestone-summary` in a target project.
...
- Contract ID: `gsd-workflow-milestone-summary`
- Status: `planned`
- Source path: `gsd-core/workflows/milestone-summary.md`
- Resolved source path: `vendor/reference/gsd-core/gsd-core/workflows/milestone-summary.md`
- Mirrored runbook path: `.agents/gsd-serena/workflows/milestone-summary.md`
...
```bash
- Native query translated: `gsd_run query init.progress` -> use the closest `gsd-serena-bridge <command> --format markdown`, resolver packet, installed contract, or explicit operation-plan step with validation.
```
...
```bash
- Native query translated: `gsd_run query state.record-session "" \` -> use the closest `gsd-serena-bridge <command> --format markdown`, resolver packet, installed contract, or explicit operation-plan step with validation.
