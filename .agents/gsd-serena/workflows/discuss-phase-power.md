# Bridge Workflow: discuss-phase-power

<!-- generated-by: pnpm gen:bridge-commands -->

## Purpose

This bridge workflow runbook translates the actual GSD-core workflow information and adapts it for Serena bridge operation. Read it when operating `gsd-workflow-discuss-phase-power` in a target project.
...
- Contract ID: `gsd-workflow-discuss-phase-power`
- Status: `planned`
- Source path: `gsd-core/workflows/discuss-phase-power.md`
- Resolved source path: `vendor/reference/gsd-core/gsd-core/workflows/discuss-phase-power.md`
- Mirrored runbook path: `.agents/gsd-serena/workflows/discuss-phase-power.md`

## Translated GSD Workflow

<purpose>
Power user mode for discuss-phase. Generates ALL questions upfront into a JSON state file and an HTML companion UI, then waits for the user to answer at their own pace. When the user signals readiness, processes all answers in one pass and generates CONTEXT...
...
<trigger>
This workflow executes when `--power` flag is present in ARGUMENTS to ``gsd-serena-bridge discuss-phase --format markdown``.
...
Consider running `gsd-serena-bridge discuss-phase --format markdown` {N} again to refine before planning.
```
...
Next step: `gsd-serena-bridge plan-phase --format markdown` {N}
