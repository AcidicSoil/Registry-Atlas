# Bridge Workflow: explore

<!-- generated-by: pnpm gen:bridge-commands -->

## Purpose

This bridge workflow runbook translates the actual GSD-core workflow information and adapts it for Serena bridge operation. Read it when operating `gsd-workflow-explore` in a target project.
...
- Contract ID: `gsd-workflow-explore`
- Status: `planned`
- Source path: `gsd-core/workflows/explore.md`
- Resolved source path: `vendor/reference/gsd-core/gsd-core/workflows/explore.md`
- Mirrored runbook path: `.agents/gsd-serena/workflows/explore.md`
