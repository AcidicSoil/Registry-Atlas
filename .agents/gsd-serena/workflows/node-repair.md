# Bridge Workflow: node-repair

<!-- generated-by: pnpm gen:bridge-commands -->

## Purpose

This bridge workflow runbook translates the actual GSD-core workflow information and adapts it for Serena bridge operation. Read it when operating `gsd-workflow-node-repair` in a target project.
...
- Contract ID: `gsd-workflow-node-repair`
- Status: `planned`
- Source path: `gsd-core/workflows/node-repair.md`
- Resolved source path: `vendor/reference/gsd-core/gsd-core/workflows/node-repair.md`
- Mirrored runbook path: `.agents/gsd-serena/workflows/node-repair.md`
