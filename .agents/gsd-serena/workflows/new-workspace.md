# Bridge Workflow: new-workspace

<!-- generated-by: pnpm gen:bridge-commands -->

## Purpose

This bridge workflow runbook translates the actual GSD-core workflow information and adapts it for Serena bridge operation. Read it when operating `gsd-workflow-new-workspace` in a target project.
...
- Contract ID: `gsd-workflow-new-workspace`
- Status: `planned`
- Source path: `gsd-core/workflows/new-workspace.md`
- Resolved source path: `vendor/reference/gsd-core/gsd-core/workflows/new-workspace.md`
- Mirrored runbook path: `.agents/gsd-serena/workflows/new-workspace.md`
...
```bash
- Native query translated: `INIT=$(gsd_run query init.new-workspace)` -> use the closest `gsd-serena-bridge <command> --format markdown`, resolver packet, installed contract, or explicit operation-plan step with validation.
