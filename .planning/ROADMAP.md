...
- [ ] 01-01-PLAN.md — Establish runnable Vitest verification and explicit test type-checking.

**Wave 2** *(blocked on Wave 1 completion)*

- [ ] 01-02-PLAN.md — Make vocabularies const-array sourced and add data invariant tests.
