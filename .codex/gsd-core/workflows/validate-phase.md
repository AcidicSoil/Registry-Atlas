...
```
Agent(
  prompt="Read /home/user/projects/temp/ai-apps/.personal-projects/registry-atlas/.codex/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/user/projects/temp/ai-apps/.personal-projects/registry-atlas/.codex/gsd-core/templates/VALIDATION.md`
