...
The keys live in `.codex/settings.json` (project) or `/home/user/projects/temp/ai-apps/.personal-projects/registry-atlas/.codex/settings.json` (global) — **not** in `.planning/config.json`:
