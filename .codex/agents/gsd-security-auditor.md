...
**Verification depth scales with `asvs_level`** (see @/home/user/projects/temp/ai-apps/.personal-projects/registry-atlas/.codex/gsd-core/references/security-asvs-levels.md for full definitions):
