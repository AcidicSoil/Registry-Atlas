        ...
        <div class="header-right">
          ...
          <div class="search-bar">
            ...
            <input
              ...
              type="search"
              class="search-input"
              placeholder="Search components, items, registries, or aliases"
            />
          </div>
          <div class="tabs" role="tablist">
            <button class="tab tab-active" data-view="discover" role="tab">
              <span class="label">Discover</span>
              <span class="badge">Component search</span>
            </button>
            <button class="tab" data-view="focus" role="tab">
